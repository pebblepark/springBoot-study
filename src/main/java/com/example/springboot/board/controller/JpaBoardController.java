...
import com.example.springboot.board.service.JpaBoardService;
...
public class JpaBoardController {
    ...
    public String writeBoard(BoardEntity board, MultipartHttpServletRequest multipartHttpServletRequest) throws Exception {
        log.debug("Start /jpa/board/write POST -------------------------------------------");
        log.debug(multipartHttpServletRequest.toString());
    ...
    public ModelAndView openDetail(@PathVariable("boardIdx") int boardIdx) throws Exception{
